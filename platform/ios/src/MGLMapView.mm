...
- (void)setStyleURL:(nullable NSURL *)styleURL
{
    ...
    [[MGLLogging sharedInstance] logPath:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] withDebugMessage:@"styleURL: %@", styleURL];
...
- (void)commonInit
{
    [[MGLLogging sharedInstance] logPath:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] withInfoMessage:@"Initializing."];
...
//    self.isAccessibilityElement = YES;
    ...
    [[MGLLogging sharedInstance] logPath:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] withInfoMessage:@"Initialization completed."];
}

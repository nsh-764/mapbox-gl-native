...
{
    // Angle at the viewpoint formed by the shortest straight lines to the
    // ground and center coordinate.
...
+ (instancetype)cameraLookingAtCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate
                                   fromDistance:(CLLocationDistance)distance
                                        ...
                                        heading:(CLLocationDirection)heading
{
    // TODO: Remove this compatibility shim in favor of `-cameraLookingAtCenterCoordinate:correctlyFromDistance:pitch:heading:.
